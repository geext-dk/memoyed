...
buildah copy $build_con src/DomainFramework/DomainFramework.csproj /app/DomainFramework/DomainFramework.csproj
buildah copy $build_con src/Domain.Cards/Domain.Cards.csproj /app/Domain.Cards/Domain.Cards.csproj
buildah copy $build_con src/Domain.Users/Domain.Users.csproj /app/Domain.Users/Domain.Users.csproj
buildah copy $build_con src/Application/Application.csproj /app/Application/Application.csproj
buildah copy $build_con src/WebApi/WebApi.csproj /app/WebApi/WebApi.csproj
...
echo "PUBLISHING"
buildah run $build_con dotnet publish -c Release -o out
...
buildah config --entrypoint '["dotnet", "Memoyed.WebApi.dll"]' $run_con
